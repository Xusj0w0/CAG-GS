# GAG-GS: Consistent Anchor Guided Gaussian Splatting for Large-Scale Scene Rendering
...
3. Prepare SAM2 embeddings. Download checkpoint from [sam2.1_hiera_large](https://dl.fbaipublicfiles.com/segment_anything_2/092824/sam2.1_hiera_large.pt) and compute the SAM2 image embeddings for the datasets. Take the Building scene as an example:
    ```bash
